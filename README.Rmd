...
__Step 1. Split Data into Train and Test Sets with Senetence Object__
```{r}
library(flaiR)
...
__Step 2 Preprocess Data and Corpus Object__  
```{r}
corpus <- Corpus(train=train, test=test)
```

__Step 3. Create Classifier Using Transformer__
```{r}
...
__Step 4. Start Training using the Classifier__
```{r eval=FALSE}
