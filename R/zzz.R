...
initialize_modules <- function() {
  tryCatch({
    # Import modules with delay_load
    ...
    # Check MPS availability for Mac
...
#' @importFrom reticulate import py_get_attr py_config use_condaenv conda_list conda_create conda_install
