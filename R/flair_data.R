...
#' most notably:
#' \itemize{
#'  \item **BoundingBox(left, top, right, bottom)**: Bases: tuple (Python); list (R)
#'   \itemize{
...
#'      \item language_code `Optional[str]` - Language of the sentence. If not provided, `langdetect` will be called when the `language_code` is accessed for the first time.
#'      \item start_position `int` - Start character offset of the sentence in the superordinate document.
#'   }
#'   \item **Span(tokens, tag=None, score=1.0)**: Bases: _PartOfSentence.
