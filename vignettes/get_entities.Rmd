...
### Batch Processing with using `get_entities_batch()`
...
Comparing the two sets of timings, the batch process faster than the process without batching when processing larger amount of data.
```{r}
