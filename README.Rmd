...
*: _On R 4.2.1, particularly when using the Matrix package on ARM 64 architecture Macs (M1/M2/M3), compatibility issues with gfortran may occur. It's recommended to avoid this combination._
